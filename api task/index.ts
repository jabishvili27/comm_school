...
async function film(name: string) {
  ...
  async function film2(name:string) {
    let data = await fetch(`
      http://www.omdbapi.com/?t=${name}&apikey=15fb000e`);
    let dataa = await data.json();
    let firstname;
  ...
  async function film3(name:string) {
    let data = await fetch(`
          http://www.omdbapi.com/?t=${name}&apikey=15fb000e`);
    let dataa = await data.json();
    let Country;
  ...
  async function film4(name:string, name2:string, name3:string) {
    let data = await fetch(`
      http://www.omdbapi.com/?t=${name}&apikey=15fb000e`);
    let dataa = await data.json();
  ...
  async function task5(film1:string, film2:string, film3:string) {
  ...
  async function getPopul(name:any) {
    let data = await fetch(`
          http://www.omdbapi.com/?t=${name}&apikey=15fb000e`);
    let dataa = await data.json();
